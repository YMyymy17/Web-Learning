...
@WebServlet("/python_uploadvideo.action")
public class Python_teacher_uploadvideo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			for (int i = 0; i < su.getFiles().getCount(); i++) {
				...
				Python p_videoup=pdao.queryzjById(vid_u);
				pdao.updatevideo(p_videoup, path1);
