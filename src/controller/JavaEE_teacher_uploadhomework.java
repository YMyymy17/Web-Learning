...
@WebServlet("/javaee_homework.action")
public class JavaEE_teacher_uploadhomework extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			for (int i = 0; i < su.getFiles().getCount(); i++) {
				...
				JavaEE j_homeworkup=jdao.queryzjById(hid_u);
				jdao.updatehomework(j_homeworkup, path1);
