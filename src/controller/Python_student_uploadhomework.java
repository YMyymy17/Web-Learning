...
@WebServlet("/python_stu_uphomework.action")
public class Python_student_uploadhomework extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			for (int i = 0; i < su.getFiles().getCount(); i++) {
				...
				python_student_homework p=new python_student_homework(sid,zjid,path1,null);
				p_hdao.add(p);
				response.sendRedirect("Python_student.action?opttype=queryall");
			}
