...
@WebServlet("/android_homework.action")
public class Android_teacher_uploadhomework extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			for (int i = 0; i < su.getFiles().getCount(); i++) {
				...
				Android a_homeworkup=adao.queryzjById(hid_u);
				adao.updatehomework(a_homeworkup, path1);
				response.sendRedirect("Android_teacher.action?opttype=queryall");
			}
