<%@ page language="java"  import="java.util.List,dao.PythonDao,entity.Python" pageEncoding="utf-8"%>
...
<body>
	...
	<table width="60%" border="1" align="center">
		...
		<tr>
			...
			<td><a href="Python_teacher.action?opttype=admindeletevideo&vid_d1=${c.id}">删除视频</a></td>
		</tr>
		</c:forEach>
	</table>
</body>
