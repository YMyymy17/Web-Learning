<%@ page language="java"  import="java.util.List,dao.AndroidDao,entity.Android" pageEncoding="utf-8"%>
...
<body>
	...
	<table width="60%" border="1" align="center">
		...
		<tr>
			...
			<td><a href="Android_teacher.action?opttype=admindeletevideo&vid_d1=${c.id}">删除视频</a></td>
		</tr>
		</c:forEach>
	</table>
</body>
