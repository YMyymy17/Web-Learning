...
<body>
	...
	<table width="60%" border="1" align="center">
		...
		<tr>
			...
			<td><a href="Python_student_homework.jsp?h_id=${c.id}">${c.homework}</a></td>
			<td>
				<a href="Python_student.action?opttype=uploadhomework&sid=<%=user.getId()%>&zjid=${c.id}&zjname=${c.name}">上传作业</a>
				<a href="Python_student.action?opttype=deletehomework&sid=<%=user.getId()%>&zjid=${c.id}">删除作业</a>
			</td>
